pipeline {
    ...
    environment {
        ...
        REPOSITORY_URL = "https://github.com/Userdead-19/kriya-hostel-sdk-main"
        BRANCH = "main"
        CREDENTIALS = "psgdcgit"
        DOCKER_CONTAINER = "kriyabackend"
        ...
        stage('Run Docker Container') {
            steps {
                script {
                    ...
                    docker run -d --name ${DOCKER_CONTAINER} -p 6003:3000 -e USERNAME=kriya25hostel -e PASSWORD=29918 -e BACKEND_URL="https://kriyabackend.psgtech.ac.in" ${DOCKER_IMAGE}:${DOCKER_IMAGE_TAG}
